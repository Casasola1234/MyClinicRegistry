...
if (isset($_POST["id"]) && !empty($_POST["id"])) {
   ...
   // Preparando una declaracion de eliminacion
    $sql = "DELETE FROM tbl_especialidad WHERE id = ?";
                    ...
                    <div class="col-md-12">
                        ...
                        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                            <div class="alert alert-danger">
                                ...
                                <p>¿Está seguro de que desea eliminar este registro de especialidad?</p>
                                <p>
                                    <input type="submit" value="Yes" class="btn btn-danger">
                                    <a href="especialidad.php" class="btn btn-secondary">No</a>
                                </p>
                            </div>
                        </form>
                    </div>
