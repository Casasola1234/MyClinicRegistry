                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="mt-5 mb-3 clearfix">
                            ...
                            <a href="./crearespecialidad.php" class="btn btn-success pull-right"><i class="fa fa-plus"></i> Añadir nueva especialidad</a>
                        </div>
                        <?php
                        ...
                        if ($result = mysqli_query($link, $sql)) {
                            if (mysqli_num_rows($result) > 0) {
                                ...
                                while ($row = mysqli_fetch_array($result)) {
                                    ...
                                    echo "<td>";
                                    echo '<a href="verespecialidad.php?id=' . $row['id'] . '" class="mr-3" title="View Record" data-toggle="tooltip"><span class="fa fa-eye"></span></a>';
                                    echo '<a href="editarespecialidad.php?id=' . $row['id'] . '" class="mr-3" title="Update Record" data-toggle="tooltip"><span class="fa fa-pencil"></span></a>';
                                    echo '<a href="deleteespecialidad.php?id=' . $row['id'] . '" title="Delete Record" data-toggle="tooltip"><span class="fa fa-trash"></span></a>';
                                    echo "</td>";
                                    echo "</tr>";
                                }
                                echo "</tbody>";
