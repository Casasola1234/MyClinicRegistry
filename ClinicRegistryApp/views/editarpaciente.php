...
if(isset($_POST["id"]) && !empty($_POST["id"])){
    ...
    $sql = "UPDATE tbl_pacientes SET nombre=?, direccion=?, email=?, telefono=? WHERE id=?";
    if(empty($nombre_err) && empty($direccion_err) && empty($email_err) && empty($telefono_err)){
        ...
        if($stmt = mysqli_prepare($link, $sql)){
            ...
            mysqli_stmt_bind_param($stmt, "ssssi", $param_nombre, $param_direccion, $param_email, $param_telefono, $param_id);
            ...
            <div class="row">
                ...
                <h2 class="mt-5">Editar paciente</h2>
                    ...
                    <div class="form-group col-lg-6 col-md-6 col-sm-6 col-xs-12">
                        ...
                        <a href="agregarpaciente.php" class="btn btn-secondary ml-2">Cancel</a>
                    </form>
                </div>
            </div>        
        </div>
