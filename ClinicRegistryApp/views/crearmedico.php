...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO tbl_medicos (nombre,direccion,email,telefono,especialidad) VALUES (?, ?, ?, ?, ?)";
   // Verifique los errores de entrada antes de insertar en la base de datos
    if (empty($nombre_err) && empty($direccion_err) && empty($email_err) && empty($telefono_err)&& empty($especialidad_err)) {
        ...
        if ($stmt = mysqli_prepare($link, $sql)) {
            ...
            mysqli_stmt_bind_param($stmt, "sssss", $param_nombre, $param_direccion, $param_email, $param_telefono, $param_especialidad);
                    ...
                    <div class="col-md-12">
                        ...
                        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                            ...
                            <div class="form-group col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                ...
                                <select type="text" name="especialidad" class="form-control <?php echo (!empty($especialidad_err)) ? 'is-invalid' : ''; ?>" value="<?php echo $especialidad; ?>">
                            ...
                            <a href="./agregarmedico.php" class="btn btn-secondary ml-2" onclick="hizoClick2">Cancel</a>
                        </form>
